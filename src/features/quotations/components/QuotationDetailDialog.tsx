...
const getStatusLabel = (status: QuotationStatus) => {
  switch (status) {
      ...
      case 'Approved': return 'Khách đã chốt';
      case 'Rejected': return 'Khách từ chối';
      default: return 'Unknown';
  }
};

export const QuotationDetailDialog = ({ open, data, onClose, onStatusChange }: Props) => {
                  ...
                  <Table size="small" sx={{ border: '1px solid #eee' }}>
                      <TableHead sx={{ bgcolor: '#e3f2fd' }}>
                          <TableRow>
                              ...
                              <TableCell><b>Kích thước (mm)</b></TableCell>
                              <TableCell align="right"><b>Đơn giá</b></TableCell>
                              <TableCell align="center"><b>SL</b></TableCell>
